...
Adder.template = [
    '<div class="annotator-adder annotator-hide">',
        '<button class="uk-button uk-button-primary" id="add_task">Add Task</button>',
        '<button class="uk-button uk-button-primary" id="add_card">Add Card</button>',
        '<button class="uk-button uk-button-primary" id="add_subcard">Add Subcard</button>',
    '</div>'
].join('\n');
